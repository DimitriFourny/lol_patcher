...
#define IMGUI_DISABLE_DEMO_WINDOWS    // Disable demo windows:
                                      // ShowDemoWindow()/ShowStyleEditor() will
                                      // be empty. Not recommended.
#define IMGUI_DISABLE_METRICS_WINDOW  // Disable debug/metrics window:
...
#define IMGUI_DISABLE_WIN32_DEFAULT_CLIPBOARD_FUNCTIONS  // [Win32] Don't
                                                         ...
                                                         // etc.
#define IMGUI_DISABLE_WIN32_DEFAULT_IME_FUNCTIONS  // [Win32] Don't implement
                                                   // default IME handler. Won't
                                                   // use and link with
                                                   // ImmGetContext/ImmSetCompositionWindow.
#define IMGUI_DISABLE_WIN32_FUNCTIONS  // [Win32] Won't use and link with any
                                       // Win32 function (clipboard, ime).
...
#define IMGUI_DISABLE_DEFAULT_FILE_FUNCTIONS  // Don't implement
                                              // ImFileOpen/ImFileClose/ImFileRead/ImFileWrite
                                              // so you can implement them
                                              // yourself if you don't want to
                                              // link with
                                              // fopen/fclose/fread/fwrite. This
                                              // will also disable the
                                              // LogToTTY() function.
...
// faster STB sprintf library implementation of vsnprintf instead of the one
// from the default C library.
